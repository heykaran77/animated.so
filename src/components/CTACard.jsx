...
const CTACard = () => {
  return (
    <Container>
      <div className="flex flex-col items-center justify-between gap-4 rounded-md bg-linear-to-r from-neutral-800 via-neutral-800 to-orange-600 px-4 py-4 font-semibold tracking-tighter md:flex-row">
