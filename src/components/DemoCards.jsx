        ...
        return (
          <div key={idx} className="group relative overflow-hidden rounded-lg">
            ...
            <button
              ...
              className={`absolute inset-0 flex cursor-pointer items-center justify-center bg-black/30 opacity-100 md:opacity-0 ${isPlaying[idx] ? "backdrop-blur-none" : "backdrop-blur-sm"} transition-opacity duration-300 md:group-hover:opacity-100`}
            >
              {isPlaying[idx] ? (
